                             ...
                             Vector3d finalAcc) const
{
    ...
    do
    {
        ...
        //traj = trajOpt.genOptimalTrajDCs3(route, initialVel, initialAcc, finalVel, finalAcc);
        //traj = trajOpt.genOptimalTrajDTs3(route, initialVel, initialAcc, finalVel, finalAcc);   // 无约束交替优化
        traj = trajOpt.genOptimalTrajDTCs3(route, initialVel, initialAcc, finalVel, finalAcc);    // 有约束交替优化
